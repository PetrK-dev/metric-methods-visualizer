...
describe('LaesaKnnAlgorithm', () => {
  ...
  beforeEach(() => {
    ...
    // Nastavení prvních dvou bodů jako pivoty - klíčový rozdíl oproti AESA
  ...
  test('execute finds correct k-nearest neighbors', async () => {
    ...
    // Spuštění algoritmu
    const iterator = LaesaKnnAlgorithm.execute(database, distanceMatrix, queryPoint, k);
